...
class DiscordMusicBot extends Client {
  ...
  ErrorEmbed(text) {
    let embed = new MessageEmbed()
      .setColor("PURPLE")
      .setDescription("<:oops_wrong:1014912471477256302> | " + text);
  ...
  createController(guild, player) {
    return new MessageActionRow().addComponents(
      new MessageButton()
        ...
        .setEmoji("<:oopsmusicstop:1015633111410815127>"),

      new MessageButton()
        .setStyle("PRIMARY")
        .setCustomId(`controller:${guild}:Replay`)
        .setEmoji("<:oopsbackk:1019864723526787134>")
        .setDisabled(
      ...
      new MessageButton()
        ...
        .setEmoji(player.playing ? "<:oops_resume:1014952759340060783>" : "<:oops_play:1014952738720845824>"),

      new MessageButton()
        .setStyle("PRIMARY")
        .setCustomId(`controller:${guild}:Next`)
        .setEmoji("<:oopsskip:1014961625612156978>"),
      ...
      new MessageButton()
        ...
        .setEmoji(player.trackRepeat ? "<:oopsrepeatonce:1019864763091656774>" : player.queueRepeat ? "<:oops_repeat:1014952778013093988>" : "<:oops_repeat:1014952778013093988>")
    );
  }
}
